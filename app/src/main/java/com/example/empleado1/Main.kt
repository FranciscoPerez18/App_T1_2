...
fun  main() {
    ...
    //Agregar los datos de el empleado..

    val staff = Employee(
        id = 1,
        fullName = "Itzel Ariadna Ramirez Lopez",
        academicLevel = AcademicLevel.MASTER,
        dateOfAdmission = LocalDate.parse("2019-11-14"),
        curp = "RALI000720MOCMPTA6",
        budgetKey = "ARI300720"
    )

    // Agregamos el periodo

    val period =com.example.empleado1.Period(
    ...
    val incident = Incident(employee = staff, currentSchedule = schedule,
        ...
        initialDate =LocalDate.parse("2020-10-08"),
        finalDate = LocalDate.parse("2020-10-30"))
